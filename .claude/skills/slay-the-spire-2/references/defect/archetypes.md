...
## Related Pages
- [Defect Tier List](tier-list.csv) — card tier rankings for Defect
- [Defect Cards](cards.csv) — full Defect card data and stats
- [Keywords Guide](../keywords/keywords.md) — keyword and mechanic definitions including Orbs, Focus, Channel, and more
